    ...
    public HappyEndingController() {
        ...
        timerHappy = new Timer(25, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (happyEndingModel
                        .getCurrentCharacterIndex() < happyEndingModel.getEnding()[happyEndingModel.getNumberHappy()]
                                .length()) {
                    happyEndingModel.getText()[happyEndingModel.getNumberHappy()]
                            .append(String.valueOf(happyEndingModel.getEnding()[happyEndingModel.getNumberHappy()]
                                    .charAt(happyEndingModel.getCurrentCharacterIndex())));
