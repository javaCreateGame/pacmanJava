...
public class BadEndingView {
    public BadEndingView(BadEndingModel happyEndingModel){
 ...
 //Set Up Các trang to của từng ending
    ...
    private void setPanel(){
        for(int i=0;i<badEndingModel.getText().length;i++){
            badEndingModel.getText()[i]=new JbadEndingModel.getText()Area();
            ...
            badEndingModel.getText()[i].setAlignmentY(JTexArea.CENTER_ALIGNMENT);
    ...
    private void setUp(){
        ...
        badEndingModel.getCardPanel().setLayout(cardLayout);
       ...
       badEndingModel.getBadEndingPanelSum()add(buttonEnding.getYesButton());
       badEndingModel.getBadEndingPanelSum()add(buttonEnding.getNoButton());
