...
public class BadEndingView {
    ...
    private void setPanel() {
        for (int i = 0; i < badEndingModel.getText().length; i++) {
            ...
            ImageIcon newImage = new ImageIcon(new ImageIcon(badEndingModel.getBadURL()[i]).getImage()
    ...
    private void setUp() {
        ...
        badEndingModel.getBadEndingPanelSum()
                .add(badEndingModel.getButtonEnding().getButtonEndingModel().getYesButton());
        badEndingModel.getBadEndingPanelSum()
                .add(badEndingModel.getButtonEnding().getButtonEndingModel().getNoButton());
